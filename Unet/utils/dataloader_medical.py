...
class UnetDataset(keras.utils.Sequence): 
    ...
    def __len__(self): #
        return math.ceil(len(self.annotation_lines) / float(self.batch_size)) #math.ceil returns smallest integer that bigger or equal to input

    def __getitem__(self, index): #generate batch data
        images  = []
        targets = []
        for i in range(index * self.batch_size, (index + 1) * self.batch_size):  
            ...
            #-------------------------------------------------------#
            #  set pixel lower than 127.5 as goal
            #-------------------------------------------------------#
    ...
    def generate(self):
        ...
        while True:
            ...
            annotation_line = self.annotation_lines[i]
